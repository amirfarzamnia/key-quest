    ...
    return (
        <div className="flex justify-between">
            <div className="container p-8 text-white w-8/12">
                ...
                <p className="mb-12 text-sm">We're poised to revolutionize the DeFi yield farming landscape by fusing AI and DAO into an ecosystem guided by AI insights and empowered by Truth Seekers. Our vision is to usher in a new era of data-driven decision-making, transparency, and community-driven governance, reshaping the way we approach yield farming.</p>
                <div className="flex justify-between">
